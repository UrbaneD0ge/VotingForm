...
let $84a264530b3fb4fb$var$suffix = document.getElementById("itmType").value;
// function to store the values of the form in local storage
function $84a264530b3fb4fb$var$storeForm() {
    // header inputs
    let NPU1 = document.getElementById("NPU").selectedOptions[0].value || "";
...
$84a264530b3fb4fb$var$submit.addEventListener("click", (e)=>{
    ...
    applNameCell.textContent = applName1;
